...
public class FatosMessageBodyReader extends GastosoCollectionMessageBodyReader<Fato>{
    public FatosMessageBodyReader() {
        super(Fato.class,UnMarshaller::parseFato);
    }
}
